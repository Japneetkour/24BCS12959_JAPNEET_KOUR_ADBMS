...
SELECT emp_city,COUNT(*) AS cnt FROM employees GROUP BY emp_city HAVING COUNT(*)=1;
SELECT emp_city,COUNT(*) AS cnt FROM employees GROUP BY emp_city ORDER BY emp_city;